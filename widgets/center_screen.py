...
class CenterScreen(QWidget):
    ...
    def init_ui(self):
        ...
        # Title label
        title_label = QLabel("Battery Data")
        title_label.setFont(self.default_font)
        main_layout.addWidget(title_label)

        # Create tabs or sections for Recent Data and All Data
        # For now, showing All Data (saved logs) as it seems to be the main functionality
